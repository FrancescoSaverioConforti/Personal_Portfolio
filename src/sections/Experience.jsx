                      ...
                      >
                        ...
                        <div className="flex flex-col items-center text-center mb-6">
                          ...
                          <div className="w-20 h-20 bg-white rounded-xl p-3 mb-4 shadow-lg group-hover:shadow-[0_0_20px_rgba(0,212,255,0.3)] transition-shadow duration-300">
                            <img
                              src={index === 0 ? "/images/maticmind-zenita.png" : "/images/maticmind.png"}
                              alt={card.company}
                              className="w-full h-full object-contain"
                              onError={(e) => {
                                e.target.style.display = 'none';
                                e.target.parentElement.innerHTML = '<div class="w-full h-full flex items-center justify-center text-black font-bold text-xl">M</div>';
                              }}
                            />
                          </div>
