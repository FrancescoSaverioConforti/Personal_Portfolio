...
// Componente per le certificazioni
const CertificationCard = ({ cert }) => {
    return (
        <div className="bg-black-200/50 backdrop-blur-lg border border-white/10 p-6 rounded-2xl hover:border-ai-primary/30 transition-all duration-500 group flex items-start gap-4 hover:shadow-[0_0_20px_rgba(0,212,255,0.15)]">
            {/* Certificate Icon */}
                                ...
                                >
                                    ...
                                    <div className="grid lg:grid-cols-2 gap-8 lg:gap-12">
                                        ...
                                        <div className="lg:pr-12 flex flex-col items-start lg:items-end">
                                            <EducationCard card={card} t={t} />
                                        </div>

                                        {/* Right Column */}
                                        <div className="lg:pl-12">
                                            <KeyFocusCard keyAreas={keyAreas} t={t} />
                                        </div>
                                    </div>
                                </div>
                            );
